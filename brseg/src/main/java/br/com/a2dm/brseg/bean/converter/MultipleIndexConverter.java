package br.com.a2dm.brseg.bean.converter;
...
@FacesConverter(value="multipleIndexConverter")
public class MultipleIndexConverter implements Converter
{
   ...
   /**
    * Obtem o SelecItem de acordo com a op��o selecionada pelo usu�rio
    */
